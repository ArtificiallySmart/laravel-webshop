<template>
  <div class="container">
    ...
    <div>
      ...
      <button v-if="!user.address || !user.phone_number" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
        Add information
      </button>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Add user information</h5>

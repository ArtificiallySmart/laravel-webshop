      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form @submit="formSubmit">
            ...
            <input type="text" id="first_name" name="first_name" v-model="user.first_name" /><br />

            <label for="last_name">Last name</label>
            <input type="text" id="last_name" name="last_name" v-model="user.last_name" /><br />

            <label for="email">e-mail</label>
            <input type="email" id="email" name="email" v-model="user.email" /><br />

            <label for="street">street</label>
            <input type="text" id="street" name="street" v-model="address.street" /><br />

            <label for="housenumber">house number</label>
            <input type="text" id="housenumber" name="house_number" v-model="address.house_number" /><br />

            <label for="zipcode">zipcode</label>
            <input type="text" id="zipcode" name="zipcode" v-model="address.zipcode" /><br />
            ...
            <input type="text" id="phonenumber" name="phone_number" v-model="phoneNumber.phone_number" />
